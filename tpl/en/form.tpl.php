<div id="form">
    ...
    <div id="pattern">
        <div class="pattern-wrapper">
            ...
            <a title="Add column" class="tooltip" id="add_column"><img src="img/addcol.png"/></a>
            <a title="Delete column" class="tooltip" id="delete_column"><img src="img/delcol.png"/></a>
            <a title="Add row" class="tooltip" id="add_row"><img src="img/addrow.png"/></a>
            <a title="Delete row" class="tooltip" id="delete_row"><img src="img/delrow.png"/></a>
            </div>
     ...
     <div id="settings">
        <div class="settings-wrapper">
            ...
            <div id="options">
                ...
                <label for="group" class="tooltip" title='"AB/A" finds "ABC/AB" <br/>("A" and "B" représentent un groupe homogène de personnages dont les entrées et les sorties sont solidaires).'><i class="fa fa-group"></i>Group characters</label>
                <input class="option-button" type="checkbox" id="ignore_confident" name="ignore_confident">
                <label for="ignore_confident" class="tooltip" title='"AB/A" trouve "AB/AC" si C est un confident.'><i class="fa fa-user-times"></i>Ignore confidants</label>
            </div>
